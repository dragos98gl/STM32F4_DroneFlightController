...
CPP_SRCS += \
../Core/libs/Utils/LowPassFilter.cpp \
../Core/libs/Utils/PID_Control.cpp \
../Core/libs/Utils/SDIODriver.cpp 

OBJS += \
./Core/libs/Utils/LowPassFilter.o \
./Core/libs/Utils/PID_Control.o \
./Core/libs/Utils/SDIODriver.o 

CPP_DEPS += \
./Core/libs/Utils/LowPassFilter.d \
./Core/libs/Utils/PID_Control.d \
./Core/libs/Utils/SDIODriver.d 
...
clean-Core-2f-libs-2f-Utils:
	-$(RM) ./Core/libs/Utils/LowPassFilter.d ./Core/libs/Utils/LowPassFilter.o ./Core/libs/Utils/LowPassFilter.su ./Core/libs/Utils/PID_Control.d ./Core/libs/Utils/PID_Control.o ./Core/libs/Utils/PID_Control.su ./Core/libs/Utils/SDIODriver.d ./Core/libs/Utils/SDIODriver.o ./Core/libs/Utils/SDIODriver.su
