...
CPP_SRCS += \
../Core/libs/nvm/FlashReadWrite.cpp 

OBJS += \
./Core/libs/nvm/FlashReadWrite.o 

CPP_DEPS += \
./Core/libs/nvm/FlashReadWrite.d 


# Each subdirectory must supply rules for building sources it contributes
Core/libs/nvm/%.o Core/libs/nvm/%.su: ../Core/libs/nvm/%.cpp Core/libs/nvm/subdir.mk
...
clean: clean-Core-2f-libs-2f-nvm

clean-Core-2f-libs-2f-nvm:
	-$(RM) ./Core/libs/nvm/FlashReadWrite.d ./Core/libs/nvm/FlashReadWrite.o ./Core/libs/nvm/FlashReadWrite.su

.PHONY: clean-Core-2f-libs-2f-nvm
